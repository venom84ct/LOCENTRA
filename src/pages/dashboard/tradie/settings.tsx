                ...
                <form onSubmit={handleSaveBusiness} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="trade" defaultValue={user.trade} />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="abn" defaultValue={user.abn} />
                    </div>
                    <div className="space-y-2">
              ...
              <CardContent>
                <form onSubmit={handleSaveNotifications} className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">Lead Recommendations</p>
                        <p className="text-sm text-muted-foreground">
                          Receive notifications about recommended job leads
                        </p>
                      </div>
                      <Switch defaultChecked />
                    </div>
...
export default TradieSettingsPage;
